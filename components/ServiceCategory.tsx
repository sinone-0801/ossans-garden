...
export default function ServiceCategory({ title, image, services, id }: ServiceCategoryProps) {
  return (
    <ResponsiveText>
      <div id={id} className="bg-ossan-box rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
        <Image
        ...
        <div className="p-6 flex-1">
          ...
          <ul className="list-none pl-0 space-y-2">
            {services.map((service, index) => (
              <li key={index} className="mb-2 pl-5 relative text-ossan-text">
